...
gs_vertbuffer_t * GL_MANGLING(device_vertexbuffer_create)(gs_device_t *device,
...
void GL_MANGLING(gs_vertexbuffer_destroy)(gs_vertbuffer_t *vb)
{
	if (vb) {
		if (vb->vertex_buffer)
...
void GL_MANGLING(gs_vertexbuffer_flush)(gs_vertbuffer_t *vb)
{
	size_t i;
...
struct gs_vb_data * GL_MANGLING(gs_vertexbuffer_get_data)(const gs_vertbuffer_t *vb)
{
	return vb->data;
}
...
void GL_MANGLING(device_load_vertexbuffer)(gs_device_t *device, gs_vertbuffer_t *vb)
{
