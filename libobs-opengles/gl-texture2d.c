...
gs_texture_t * GL_MANGLING(device_texture_create)(gs_device_t *device, uint32_t width,
...
void GL_MANGLING(gs_texture_destroy)(gs_texture_t *tex)
{
...
uint32_t GL_MANGLING(gs_texture_get_width)(const gs_texture_t *tex)
{
...
uint32_t GL_MANGLING(gs_texture_get_height)(const gs_texture_t *tex)
{
	const struct gs_texture_2d *tex2d = (const struct gs_texture_2d*)tex;
...
enum gs_color_format GL_MANGLING(gs_texture_get_color_format)(const gs_texture_t *tex)
{
	return tex->format;
}

bool GL_MANGLING(gs_texture_map)(gs_texture_t *tex, uint8_t **ptr, uint32_t *linesize)
{
	struct gs_texture_2d *tex2d = (struct gs_texture_2d*)tex;
...
void GL_MANGLING(gs_texture_unmap)(gs_texture_t *tex)
{
	struct gs_texture_2d *tex2d = (struct gs_texture_2d*)tex;
