...
gs_indexbuffer_t * GL_MANGLING(device_indexbuffer_create)(gs_device_t *device,
...
void GL_MANGLING(gs_indexbuffer_destroy)(gs_indexbuffer_t *ib)
{
	if (ib) {
		if (ib->buffer)
...
void GL_MANGLING(gs_indexbuffer_flush)(gs_indexbuffer_t *ib)
{
	if (!ib->dynamic) {
...
void * GL_MANGLING(gs_indexbuffer_get_data)(const gs_indexbuffer_t *ib)
{
	return ib->data;
}

size_t GL_MANGLING(gs_indexbuffer_get_num_indices)(const gs_indexbuffer_t *ib)
{
	return ib->num;
}

enum gs_index_type GL_MANGLING(gs_indexbuffer_get_type)(const gs_indexbuffer_t *ib)
{
	return ib->type;
}

void GL_MANGLING(device_load_indexbuffer)(gs_device_t *device, gs_indexbuffer_t *ib)
{
