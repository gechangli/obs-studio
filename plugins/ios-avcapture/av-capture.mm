...
// declare module
OBS_DECLARE_MODULE(ios_avcapture)
OBS_MODULE_USE_DEFAULT_LOCALE(ios_avcapture, "zh-CN")
...
#define TEXT_AVCAPTURE  MODULE_MANGLING(obs_module_text)("AVCapture")
#define TEXT_DEVICE     MODULE_MANGLING(obs_module_text)("Device")
#define TEXT_USE_PRESET MODULE_MANGLING(obs_module_text)("UsePreset")
#define TEXT_PRESET     MODULE_MANGLING(obs_module_text)("Preset")
#define TEXT_RESOLUTION MODULE_MANGLING(obs_module_text)("Resolution")
#define TEXT_FRAME_RATE MODULE_MANGLING(obs_module_text)("FrameRate")
#define TEXT_MATCH_OBS  MODULE_MANGLING(obs_module_text)("MatchOBS")
#define TEXT_INPUT_FORMAT MODULE_MANGLING(obs_module_text)("InputFormat")
#define TEXT_COLOR_SPACE MODULE_MANGLING(obs_module_text)("ColorSpace")
#define TEXT_VIDEO_RANGE MODULE_MANGLING(obs_module_text)("VideoRange")
#define TEXT_RANGE_PARTIAL MODULE_MANGLING(obs_module_text)("VideoRange.Partial")
#define TEXT_RANGE_FULL MODULE_MANGLING(obs_module_text)("VideoRange.Full")
#define TEXT_AUTO       MODULE_MANGLING(obs_module_text)("Auto")
...
static inline void handle_disconnect_capture(av_capture *capture,
		AVCaptureDevice *dev)
{
	if (![dev.uniqueID isEqualToString:capture->uid])
		return;
		...
		const size_t count, const char *localization_name)
{
	...
	dstr_init_copy(label, MODULE_MANGLING(obs_module_text)(localization_name));
...
static obs_properties_t *av_capture_properties(void *capture)
{
	...
	obs_properties_add_bool(props, "buffering",
			MODULE_MANGLING(obs_module_text)("Buffering"));
...
obs_module_t* STATIC_MODULE_CREATOR(ios_avcapture)() {
    obs_module_t* mod = (obs_module_t*)bzalloc(sizeof(obs_module_t));
    mod->mod_name = bstrdup("ios_avcapture");
    mod->file = bstrdup("ios_avcapture");
