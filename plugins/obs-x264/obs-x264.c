...
#define TEXT_RATE_CONTROL MODULE_MANGLING(obs_module_text)("RateControl")
#define TEXT_BITRATE    MODULE_MANGLING(obs_module_text)("Bitrate")
#define TEXT_CUSTOM_BUF MODULE_MANGLING(obs_module_text)("CustomBufsize")
#define TEXT_BUF_SIZE   MODULE_MANGLING(obs_module_text)("BufferSize")
#define TEXT_VFR        MODULE_MANGLING(obs_module_text)("VFR")
#define TEXT_CRF        MODULE_MANGLING(obs_module_text)("CRF")
#define TEXT_KEYINT_SEC MODULE_MANGLING(obs_module_text)("KeyframeIntervalSec")
#define TEXT_PRESET     MODULE_MANGLING(obs_module_text)("CPUPreset")
#define TEXT_PROFILE    MODULE_MANGLING(obs_module_text)("Profile")
#define TEXT_TUNE       MODULE_MANGLING(obs_module_text)("Tune")
#define TEXT_NONE       MODULE_MANGLING(obs_module_text)("None")
#define TEXT_X264_OPTS  MODULE_MANGLING(obs_module_text)("EncoderOptions")
